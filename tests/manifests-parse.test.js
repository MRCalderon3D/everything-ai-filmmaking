...
assert.strictEqual(skills.length, 19, `expected 19 skills, got ${skills.length}`);
...
assert.strictEqual(profiles.full.commands.length, 19);
assert.strictEqual(profiles.full.agents.length, 17);
assert.strictEqual(profiles.full.skills.length, 19);
