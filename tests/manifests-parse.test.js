...
assert.strictEqual(commands.length, 18, `expected 18 commands, got ${commands.length}`);
...
assert.strictEqual(skills.length, 18, `expected 18 skills, got ${skills.length}`);
...
assert.strictEqual(profiles.full.commands.length, 18);
assert.strictEqual(profiles.full.agents.length, 17);
assert.strictEqual(profiles.full.skills.length, 18);
