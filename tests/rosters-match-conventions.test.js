...
assert.strictEqual(rosters.counts.commands, 21);
assert.strictEqual(rosters.counts.skills, 21);
...
assert.strictEqual(rosters.commands.length, 21);
assert.strictEqual(rosters.skills.length, 21);
