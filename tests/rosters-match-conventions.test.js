...
assert.strictEqual(rosters.counts.commands, 18);
assert.strictEqual(rosters.counts.skills, 18);
...
assert.strictEqual(rosters.commands.length, 18);
assert.strictEqual(rosters.skills.length, 18);
